...
| file | contents |
|---|---|
| `index.ts` | `export const fat16: FsFamily<FormatOptions>` (`format: (o) => Volume.formatFat16(o)`, `bind: (v) => new Fat16Adapter(v)`, `mkfs: MKFS`); `export type Fat16FormatOptions = FormatOptions`; `asFat16(fs: FsAdapter): Fat16Adapter` (throws unless `fs.id === "fat16"`); re-exports of the moved helpers |
